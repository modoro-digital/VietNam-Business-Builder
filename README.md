...
> **Đóng gói doanh nghiệp tự động** — Plugin AI cho Claude Code/Cowork tự sinh **204 tài liệu vận hành** chuẩn hóa cho doanh nghiệp Việt Nam, theo kiến trúc 5 tầng (ISO 9001, EOS, McKinsey 7S, SYSTEMology) và tuân thủ pháp luật Việt Nam.
...
- **Output:** Bộ **204 tài liệu vận hành** hoàn chỉnh trong cây thư mục có hướng dẫn — từ điều lệ, OKR, JD, SOP, quy trình, KPI, đến pitch deck và financial model.
...
| 4 | `bp-people` | 2 | 28 | Nhân sự & Con người |
| 5 | `bp-operations` | 2 | 21 | Hành chính & Vận hành |
| 6 | `bp-sales` | 3 | 18 | Kinh doanh & Bán hàng |
| 7 | `bp-marketing` | 3 | 19 | Marketing & Thương hiệu |
...
**Tổng: 218 file Markdown · 204 prompt files · 13 skills · 5 tầng kiến trúc**
