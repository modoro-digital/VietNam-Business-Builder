...
CROSS-REFERENCE: Đây là quy chế bảo mật cho nhân sự. Chính sách bảo vệ dữ liệu pháp lý xem bp-governance/Chính sách bảo vệ dữ liệu. An ninh mạng kỹ thuật xem bp-product-tech/Chính sách an ninh mạng.
```
