...
CROSS-REFERENCE: Đây là chính sách an ninh mạng kỹ thuật. Chính sách bảo vệ dữ liệu pháp lý xem bb-governance/Chính sách bảo vệ dữ liệu. Quy chế bảo mật nhân sự xem bb-people/Quy chế bảo mật thông tin.
```
