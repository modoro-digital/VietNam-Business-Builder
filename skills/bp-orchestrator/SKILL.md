...
- Đọc file `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/bo-cau-hoi-intake.md`
...
- Đọc `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/danh-gia-scope.md` và `cham-diem-truong-thanh.md`
...
- Đọc `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/cay-thu-muc-chuan.md`
- Tạo scaffold toàn bộ cấu trúc thư mục cho DN

### Bước 4: Gọi tuần tự 12 skill con
- Đọc `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/luong-thuc-thi.md`
...
- Đọc `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/checklist-chat-luong.md`
- Verify completeness — đối chiếu output thực tế vs kỳ vọng
- Tạo báo cáo bàn giao theo `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/bao-cao-ban-giao.md`
...
📋 **File tham chiếu đầy đủ:** `${CLAUDE_PLUGIN_ROOT}/skills/bp-orchestrator/references/quy-tac-luu-tru-drive.md`
